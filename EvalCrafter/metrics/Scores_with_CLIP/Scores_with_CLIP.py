...
if __name__ == '__main__':
    ...
    parser.add_argument("--result_dir", type=str, default='results', help="Specify the directory to save the results")
    ...
    if metric == 'blip_bleu': 
        ...
        pipe = StableDiffusionXLPipeline.from_pretrained(
            "/app/data/stable-diffusion-xl-base-1.0", torch_dtype=torch.float16)
        pipe = pipe.to(device)
    else:
        clip_model = CLIPModel.from_pretrained("../../checkpoints/clip-vit-base-patch32").to(device)
        clip_tokenizer = AutoTokenizer.from_pretrained("../../checkpoints/clip-vit-base-patch32")
